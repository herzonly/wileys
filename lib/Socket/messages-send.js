...
const makeMessagesSocket = (config) => {
    ...
    if (!options.ephemeralExpiration) {
        if ((0, WABinary_1.isJidGroup)(jid)) {
            ...
            const expiration = ((_b = (_a = (0, WABinary_1.getBinaryNodeChild)(metadata, 'ephemeral')) === null || _a === void 0 ? void 0 : _a.attrs) === null || _b === void 0 ? void 0 : _b.expiration) || Date.now();
            options.ephemeralExpiration = expiration ? Date.now() : 0;
        }
    }
